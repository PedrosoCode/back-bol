...
\restrict v1WFiCFpMuh1uZtkElJCwLcXPKs18gCJ4FF8y5fjsAqFkSKaH2ntPFIvRQP5hyB

-- Dumped from database version 16.10 (Ubuntu 16.10-0ubuntu0.24.04.1)
-- Dumped by pg_dump version 16.10 (Ubuntu 16.10-0ubuntu0.24.04.1)

-- Started on 2025-10-14 22:23:50 -03
...
--
-- TOC entry 228 (class 1255 OID 17332)
...
--
-- TOC entry 229 (class 1255 OID 17336)
...
--
-- TOC entry 246 (class 1255 OID 17379)
-- Name: fn_parceiro_negocio_select(integer, integer, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_parceiro_negocio_select(p_codigo integer, p_codigo_empresa integer, p_nome character varying) RETURNS TABLE("nCodigo" integer, "nCodigoEmpresa" integer, "sNomeFantasia" character varying, "sRazaoSocial" character varying, "sCnpjCpf" character varying, "nCodigoPais" integer, "nCodigoEstado" integer, "nCodigoCidade" integer, "sBairro" character varying, "sRua" character varying, "sNrua" character varying, "sCep" character varying, "sPais" character varying, "sEstado" character varying, "sCidade" character varying, "sContato" character varying, "sEmail" character varying, "sTelefone" character varying, "sComplemento" character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    SELECT 
        parceiro.codigo AS nCodigo,
        parceiro.codigo_empresa AS nCodigoEmpresa,
        parceiro.nome_fantasia AS sNomeFantasia,
        parceiro.razao_social AS sRazaoSocial,
        parceiro.cnpj_cpf AS sCnpjCpf,
        parceiro.codigo_pais AS nCodigoPais,
        parceiro.codigo_estado AS nCodigoEstado,
        parceiro.codigo_cidade AS nCodigoCidade,
        parceiro.bairro AS sBairro,
        parceiro.rua AS sRua,
        parceiro.n_rua AS sNrua,
        parceiro.cep AS sCep,
        tb_stc_pais.nome_pt AS sPais,
        tb_stc_estado.nome AS sEstado,
        tb_stc_cidade.nome AS sCidade,
		parceiro.contato AS sContato,
		parceiro.telefone AS sTelefone,
		parceiro.email AS sEmail,
		parceiro.complemento AS sComplemento
    FROM tb_cad_parceiro_negocio parceiro
    LEFT JOIN tb_stc_pais 
        ON tb_stc_pais.id = parceiro.codigo_pais
    LEFT JOIN tb_stc_estado
        ON tb_stc_estado.id = parceiro.codigo_estado
    LEFT JOIN tb_stc_cidade
        ON tb_stc_cidade.id = parceiro.codigo_cidade
    WHERE (parceiro.codigo = p_codigo OR p_codigo IS NULL)
      AND (parceiro.codigo_empresa = p_codigo_empresa)
	  AND (
	  		parceiro.nome_fantasia ILIKE '%' || p_nome || '%' 
		  OR parceiro.razao_social ILIKE '%' || p_nome || '%' 
		  OR p_nome = ''
		);
...
ALTER FUNCTION public.fn_parceiro_negocio_select(p_codigo integer, p_codigo_empresa integer, p_nome character varying) OWNER TO postgres;

--
-- TOC entry 230 (class 1255 OID 17389)
-- Name: fn_stc_combo_cidade(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_stc_combo_cidade(p_codigo_estado integer) RETURNS TABLE("nCodigoCidade" integer, "sNomeCidade" character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
	RETURN QUERY
	SELECT
		tb_stc_cidade.id AS "nCodigoCidade",
		(tb_stc_cidade.nome || ' - ' || tb_stc_estado.uf)::VARCHAR AS "sNomeCidade"
	FROM tb_stc_cidade 
	LEFT JOIN tb_stc_estado
	ON tb_stc_estado.id = tb_stc_cidade.uf
	WHERE (tb_stc_cidade.uf = p_codigo_estado OR p_codigo_estado IS NULL);
END;
$$;
...
CREATE FUNCTION public.fn_stc_combo_estado() RETURNS TABLE("nCodigoEstado" integer, "sNomeEstado" character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
	RETURN QUERY
...
--
-- TOC entry 244 (class 1255 OID 17381)
-- Name: fn_stc_combo_pais(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_stc_combo_pais() RETURNS TABLE("nCodigoPais" integer, "sNomePais" character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
	RETURN QUERY
...
-- Name: sp_parceiro_negocio_delete(integer, integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.sp_parceiro_negocio_delete(IN p_codigo integer, IN p_codigo_empresa integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER PROCEDURE public.sp_parceiro_negocio_delete(IN p_codigo integer, IN p_codigo_empresa integer) OWNER TO postgres;

--
-- TOC entry 227 (class 1255 OID 17359)
-- Name: sp_parceiro_negocio_insert(integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.sp_parceiro_negocio_insert(IN p_codigo_empresa integer, OUT p_codigo integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE PROCEDURE public.sp_parceiro_negocio_update(IN p_codigo integer, IN p_codigo_empresa integer, IN p_nome_fantasia character varying, IN p_razao_social character varying, IN p_cnpj_cpf character varying, IN p_codigo_pais integer, IN p_codigo_estado integer, IN p_codigo_cidade integer, IN p_bairro character varying, IN p_rua character varying, IN p_n_rua character varying, IN p_cep character varying, IN p_email character varying, IN p_telefone character varying, IN p_contato character varying, IN p_complemento character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
	...
	WHERE tb_cad_parceiro_negocio.codigo_empresa = p_codigo_empresa
	AND tb_cad_parceiro_negocio.codigo = p_codigo;

END
$$;


ALTER PROCEDURE public.sp_parceiro_negocio_update(IN p_codigo integer, IN p_codigo_empresa integer, IN p_nome_fantasia character varying, IN p_razao_social character varying, IN p_cnpj_cpf character varying, IN p_codigo_pais integer, IN p_codigo_estado integer, IN p_codigo_cidade integer, IN p_bairro character varying, IN p_rua character varying, IN p_n_rua character varying, IN p_cep character varying, IN p_email character varying, IN p_telefone character varying, IN p_contato character varying, IN p_complemento character varying) OWNER TO postgres;
...
-- Name: tb_stc_cidade; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_stc_cidade (
    id integer NOT NULL,
    nome character varying,
    uf integer,
    ibge integer
...
ALTER TABLE public.tb_stc_cidade OWNER TO postgres;

--
-- TOC entry 225 (class 1259 OID 17344)
-- Name: tb_stc_estado; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_stc_estado (
    id integer NOT NULL,
    nome character varying,
...
ALTER TABLE public.tb_stc_estado OWNER TO postgres;

--
-- TOC entry 224 (class 1259 OID 17337)
-- Name: tb_stc_pais; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tb_stc_pais (
    id integer NOT NULL,
    nome character varying,
...
--
-- TOC entry 3480 (class 0 OID 17177)
-- Dependencies: 215
...
--
-- TOC entry 3482 (class 0 OID 17211)
-- Dependencies: 217
...
--
-- TOC entry 3487 (class 0 OID 17295)
-- Dependencies: 222
...
--
-- TOC entry 3481 (class 0 OID 17184)
-- Dependencies: 216
...
--
-- TOC entry 3483 (class 0 OID 17223)
-- Dependencies: 218
...
--
-- TOC entry 3486 (class 0 OID 17283)
-- Dependencies: 221
...
--
-- TOC entry 3488 (class 0 OID 17312)
-- Dependencies: 223
...
--
-- TOC entry 3484 (class 0 OID 17248)
-- Dependencies: 219
...
--
-- TOC entry 3485 (class 0 OID 17273)
-- Dependencies: 220
...
--
-- TOC entry 3491 (class 0 OID 17351)
-- Dependencies: 226
-- Data for Name: tb_stc_cidade; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_stc_cidade (id, nome, uf, ibge) FROM stdin;
...
--
-- TOC entry 3490 (class 0 OID 17344)
-- Dependencies: 225
-- Data for Name: tb_stc_estado; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_stc_estado (id, nome, uf, ibge, pais, ddd) FROM stdin;
1	Acre	AC	12	1	68
...
--
-- TOC entry 3489 (class 0 OID 17337)
-- Dependencies: 224
-- Data for Name: tb_stc_pais; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_stc_pais (id, nome, nome_pt, sigla, bacen) FROM stdin;
...
--
-- TOC entry 3308 (class 2606 OID 17217)
...
--
-- TOC entry 3318 (class 2606 OID 17301)
...
--
-- TOC entry 3312 (class 2606 OID 17252)
...
--
-- TOC entry 3314 (class 2606 OID 17277)
...
--
-- TOC entry 3306 (class 2606 OID 17190)
...
--
-- TOC entry 3310 (class 2606 OID 17229)
...
--
-- TOC entry 3316 (class 2606 OID 17289)
...
--
-- TOC entry 3320 (class 2606 OID 17318)
...
--
-- TOC entry 3304 (class 2606 OID 17183)
...
--
-- TOC entry 3326 (class 2606 OID 17357)
-- Name: tb_stc_cidade tb_stc_cidade_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_stc_cidade
    ADD CONSTRAINT tb_stc_cidade_pkey PRIMARY KEY (id);


--
-- TOC entry 3324 (class 2606 OID 17350)
-- Name: tb_stc_estado tb_stc_estado_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_stc_estado
    ADD CONSTRAINT tb_stc_estado_pkey PRIMARY KEY (id);


--
-- TOC entry 3322 (class 2606 OID 17343)
-- Name: tb_stc_pais tb_stc_pais_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_stc_pais
    ADD CONSTRAINT tb_stc_pais_pkey PRIMARY KEY (id);


--
-- TOC entry 3328 (class 2606 OID 17218)
...
--
-- TOC entry 3329 (class 2606 OID 17230)
...
--
-- TOC entry 3334 (class 2606 OID 17302)
...
--
-- TOC entry 3330 (class 2606 OID 17253)
...
--
-- TOC entry 3332 (class 2606 OID 17278)
...
--
-- TOC entry 3331 (class 2606 OID 17258)
...
--
-- TOC entry 3327 (class 2606 OID 17191)
...
--
-- TOC entry 3333 (class 2606 OID 17290)
...
--
-- TOC entry 3336 (class 2606 OID 17319)
...
-- Completed on 2025-10-14 22:23:51 -03

--
-- PostgreSQL database dump complete
--

\unrestrict v1WFiCFpMuh1uZtkElJCwLcXPKs18gCJ4FF8y5fjsAqFkSKaH2ntPFIvRQP5hyB
